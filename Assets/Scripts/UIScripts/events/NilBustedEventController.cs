...
public class NilBustedEventController : MonoBehaviour
{
    ...
    public static void nilBustedLogic(PlayerPosition pos) {
        ...
        GameObject.Find("southbidvalv2").GetComponent<TMP_Text>().text = "Busted";        
        //Also add a notification in the top.
        GameObject.Find("ScriptEmpty").GetComponent<WarningScript>().showWarningAndDisappear(new WarningEntity("Nil Busted for " + pos.ToString(), ""));
